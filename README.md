...
```javascript
dmskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmskrange@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dmskrange/tags). For example,

```javascript
dmskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmskrange@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dmskrange = require( 'path/to/vendor/umd/stats-strided-dmskrange/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dmskrange@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dmskrange.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dmskrange

[test-image]: https://github.com/stdlib-js/stats-strided-dmskrange/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dmskrange/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dmskrange/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dmskrange?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dmskrange.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dmskrange/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dmskrange/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dmskrange/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dmskrange/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dmskrange/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dmskrange/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dmskrange/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dmskrange/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dmskrange/main/LICENSE
